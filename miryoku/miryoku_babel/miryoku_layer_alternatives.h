...
U_BOOT,            &u_to_U_BASE,      &u_to_U_BASE,      &u_to_U_GAME,      &u_to_U_GAME,      U_RGB_EFF,         U_RGB_HUI,         U_RGB_SAI,         U_RGB_BRI,         U_RGB_TOG,         \
...
&kp LBKT,          &kp N7,            &kp N8,            &kp N9,            &kp RBKT,          &u_to_U_GAME,      &u_to_U_GAME,      &u_to_U_BASE,      &u_to_U_BASE,      U_BOOT,            \
...
&kp LBRC,          &kp AMPS,          &kp ASTRK,         &kp LPAR,          &kp RBRC,          &u_to_U_GAME,      &u_to_U_GAME,      &u_to_U_BASE,      &u_to_U_BASE,      U_BOOT,            \
&kp COLON,         &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
&kp TILDE,         &kp EXCL,          &kp AT,            &kp HASH,          &kp PIPE,          U_NA,              &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp LPAR,          &kp RPAR,          &kp UNDER,         U_NA,              U_NA,              U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_FUN \
&kp F12,           &kp F7,            &kp F8,            &kp F9,            &kp PSCRN,         &u_to_U_GAME,      &u_to_U_GAME,      &u_to_U_BASE,      &u_to_U_BASE,      U_BOOT,            \
